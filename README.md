...
OCI Object Storage (Standard) -> rclone (Continuous sync every 30–60 seconds) -> Amazon S3 (Standard / Infrequent Access) -> Lifecycle Policy (30–90 days) -> Amazon Glacier (Archive)
